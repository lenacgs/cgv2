...
GLfloat brownAmb[] = { 0.04 ,0.025 ,0.0125 };
GLfloat brownDif[] = { 0.16 ,0.1 ,0.005 };

GLfloat lightBrownAmb[] = { 0.08 ,0.05 ,0.025 };
GLfloat lightBrownDif[] = { 0.32 ,0.2 ,0.01 };
...
GLfloat  jadeAmb[] = { 0.0675 ,0.11125 ,0.07875 };
...
GLfloat blackPlasticAmb[] = { 0.001 ,0.001 ,0.001 };
